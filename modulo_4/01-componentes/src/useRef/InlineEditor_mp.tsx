...
export default function InlineEditor() {
  ...
  const [saved, setSaved] = useState('Escribe el cargo y guarda')
  ...
  return (
    <div style={{ maxWidth: 340, display: 'flex', flexDirection: 'column', gap: 10 }}>
      <p style={{ margin: 0, color: '#6b7280', fontSize: 13 }}>
        Cargo guardado: <strong style={{ color: '#111827' }}>{saved}</strong>
      </p>

      <input
        ref={inputRef}
        defaultValue=""
        placeholder="Cargo del empleado (sin causar re-renders)..."
