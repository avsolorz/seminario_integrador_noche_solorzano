...
interface FormState {
  ...
  email:    string
  password: string
  errors:   Partial<Record<'name' | 'apellido' | 'email' | 'password', string>>
  status:   'idle' | 'submitting' | 'success' | 'error'
}

type FormAction =
  | { type: 'SET_FIELD'; field: keyof Pick<FormState, 'name' | 'email' | 'password' | 'apellido'>; value: string }
...
// Registro de un nuevo empleado en el sistema de nómina
