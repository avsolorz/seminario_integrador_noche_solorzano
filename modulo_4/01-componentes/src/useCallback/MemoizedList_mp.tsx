...
const INITIAL_TASKS: Task[] = [
  { id: 1, text: 'Revisar aportes IESS',        completed: false },
  { id: 2, text: 'Calcular horas extra',        completed: true  },
  { id: 3, text: 'Validar cuentas bancarias',   completed: false },
  { id: 4, text: 'Aprobar roles de pago',       completed: false },
  { id: 5, text: 'Cerrar nómina del mes',       completed: false },
]
