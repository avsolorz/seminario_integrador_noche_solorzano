...
const EMPLOYEES: Employee[] = [
  { id: 1, name: 'Gabriela Calderón', department: 'Ventas',        salary: 460,  active: true  },
  { id: 2, name: 'Jorge Vera',        department: 'Bodega',        salary: 650,  active: true  },
  { id: 3, name: 'Mateo Alba',        department: 'Contabilidad',  salary: 980,  active: false },
  { id: 4, name: 'Ana Chiluisa',      department: 'Ventas',        salary: 520,  active: true  },
  { id: 5, name: 'Pedro Salazar',     department: 'Bodega',        salary: 460,  active: true  },
  { id: 6, name: 'Lucía Vega',        department: 'Contabilidad',  salary: 720,  active: false },
]
  ...
  return (
    <div style={{ fontFamily: 'sans-serif', maxWidth: 700, margin: '0 auto', padding: 24 }}>
      ...
      <p style={{ color: '#666', fontSize: 14, marginBottom: 20 }}>
        Tres callbacks estables para una tabla de nómina con <code>React.memo</code>. Cambiar filtros no re-renderiza las filas.
      </p>
      ...
      <div style={{ display: 'flex', gap: 16, marginBottom: 16, flexWrap: 'wrap' }}>
        ...
        <span style={{ fontSize: 13, color: '#888', alignSelf: 'center' }}>
          {visible.length} empleado{visible.length !== 1 ? 's' : ''} · Total nómina: ${totalSalary.toLocaleString()}
        </span>
      </div>
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
        <thead>
          <tr style={{ background: '#f5f5f5' }}>
            {['Nombre', 'Depto.', 'Sueldo', 'Estado', 'Acciones'].map(h => (
              <th key={h} style={{
                textAlign:    'left',
                padding:      '8px 12px',
