...
// Reutiliza la API pública de JSONPlaceholder (/users) — reinterpretamos
// cada "user" como un empleado del directorio.
  ...
  return (
    <div style={{ fontFamily: 'sans-serif', maxWidth: 540, margin: '0 auto', padding: 24 }}>
      ...
      <p style={{ color: '#666', fontSize: 14, marginBottom: 20 }}>
        <code>useCallback</code> con <code>[page]</code> como dep — fetch de empleados al cambiar de página.
      </p>
      ...
      <p style={{ textAlign: 'center', fontSize: 12, color: '#aaa', marginTop: 10 }}>
        Página {page} de {totalPages} · {total} empleados en total
      </p>
    </div>
  )
}
